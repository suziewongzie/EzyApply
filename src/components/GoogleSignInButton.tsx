...
export function GoogleSignInButton({ onClick, isLoading }: GoogleSignInButtonProps) {
  return (
    <button
      ...
      disabled={isLoading}
      id="gsi-sign-in-btn"
      className="gsi-material-button w-full flex items-center justify-center py-3 px-4 border border-slate-200 rounded-xl bg-white text-slate-700 font-medium hover:bg-slate-50 active:bg-slate-100 transition shadow-sm cursor-pointer disabled:opacity-50"
    >
